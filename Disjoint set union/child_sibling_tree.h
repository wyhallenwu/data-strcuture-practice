//
// Created by wuliwyh on 2021/3/30.
//

#ifndef DISJOINT_SET_UNION_CHILD_SIBLING_TREE_H
#define DISJOINT_SET_UNION_CHILD_SIBLING_TREE_H
#include <iostream>
#include <queue>
using namespace std;
template <typename T>
...
public:
    ...
    void insert(T goal,T data_,int i) // i==0 denote that it's a child
                                      // or else i==1 means it's a sibling
    {
...
#endif //DISJOINT_SET_UNION_CHILD_SIBLING_TREE_H
